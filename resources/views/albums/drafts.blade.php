...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .main-content { padding: 1.75rem 1.75rem 3rem; flex: 1; }
        .page-heading { font-size: 1.1rem; font-weight: 700; color: #e8edf5; margin-bottom: 1.25rem; }
        ...
        .album-card-link:hover .album-card {
            ...
            box-shadow: 0 8px 28px rgba(255,193,7,0.08);
        }
        ...
        .album-info .meta { font-size: .7rem; color: rgba(255,255,255,.28); margin-top: .35rem; flex-shrink: 0; }
    </style>
</head>
<body>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('albums.drafts') }}" class="sidebar-item active">
            ...
            @if ($albums->isNotEmpty())
                <span class="sidebar-badge">{{ $albums->count() }}</span>
            @endif
        </a>
    </nav>
    ...
    <div class="main-content">
        ...
        @if ($albums->isEmpty())
            <div class="text-center py-5 text-secondary">
                ...
                <p class="small opacity-50">Importe um album e salve como rascunho para ele aparecer aqui.</p>
            </div>
        @else
